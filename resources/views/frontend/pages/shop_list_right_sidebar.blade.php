                ...
                <div class="row">
                    <div class="col-12">
                        <div class="breadcumb-content">
                            <h1 class="breadcumb-title">Shop List Right Sidebar</h1>
        ...
        <div class="shop-wrapper style1">
            <div class="container">
                <div class="row gy-5">
                        ...
                        <div class="dishes-card-wrap style3">
                            <div class="dishes-card style4 wow fadeInUp" data-wow-delay="0.2s">
                                ...
                                <div class="dishes-content">
                                    ...
                                    <div class="text">Neque porro est qui dolorem ipsum quia quaed inventor veritatis et
                    ...
                    <div class="order-1 col-xl-3 col-lg-4 order-md-2 wow fadeInUp" data-wow-delay=".3s">
