        ...
        <div class="max-lg:px-4">
            ...
            <div
                ...
                <div class="p-3 mb-3 overflow-hidden bg-white minfo__sidebar dark:bg-nightBlack rounded-2xl">
                    ...
                    <div class="px-4 py-5 lg:py-6 lg:px-6 rounded-2xl md:px-8 bg-flashWhite dark:bg-metalBlack">
                        ...
                        <div class="mt-6">
                            <a href="https://drive.google.com/file/d/10gsjir55mCh5K5zZvMMfnu8eaK70-hLg/view?usp=sharing" download target="_blank"
                    ...
                    <svg class="absolute w-0 h-0">
                        <clipPath id="my-clip-path" clipPathUnits="objectBoundingBox" stroke="white"
                            stroke-width="2">
                            <path
            ...
            <div
                ...
                <div
                    ...
                    <a href='index.html'>
                        <img src="{{ asset('assets/frontend/assets/img/site-logo.svg') }}" alt="Minfo">
                        {{-- <img src="{{ asset('assets/frontend/assets/img/newaz.jpg') }}" alt="Minfo"> --}}
                    </a>
                </div>
                <!-- Site Logo Start -->
            ...
            <div class="relative mx-auto minfo__contentBox max-w-container xl:max-2xl:max-w-65rem">
                ...
                <div data-scroll-index="0" id="home"
                    ...
                    <div
                        class="px-5 py-8 bg-white dark:bg-nightBlack rounded-2xl hero-section md:p-8 lg:p-10 2xl:p-13">
                        <div
                        ...
                        <div class="items-center gap-6 hero-content md:flex xl:gap-10">
                            <div class="text-content pt-7 lg:pt-8 max-lg:max-w-[30rem]">
                                ...
                                <p>
                                    I am a <span class="font-medium text-black dark:text-white/90">Frontend/Backend
                                        Developer</span> at heart and, i create features that are best suited for the
                                    job at hand.
                                </p>
                            ...
                            <div class="hero-image flex-[0_0_20.3rem] max-md:hidden">
                                <!-- <img src="{{ asset('assets/frontend/assets/img/hero-img-1.png') }}" -->
                                <img src="{{ asset('assets/frontend/assets/img/newaz.jpg') }}"
                                    class="dark:hidden" alt="Hero Image - Light Mode">
                                <!-- <img src="{{ asset('assets/frontend/assets/img/hero-img-2.png') }}" -->
                                  <img src="{{ asset('assets/frontend/assets/img/newaz.jpg') }}"
                                    ...
                                    <div class="swiper">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="#" class="transition duration-200 flex-center">
                                                    <img src="{{ asset('assets/frontend/assets/img/partners/logo1.svg') }}"
                                                        alt="Partner Name">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="#" class="transition duration-200 flex-center">
                                                    <img src="{{ asset('assets/frontend/assets/img/partners/logo2.svg') }}"
                                                        alt="Partner Name">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="#" class="transition duration-200 flex-center">
                                                    <img src="{{ asset('assets/frontend/assets/img/partners/logo3.svg') }}"
                                                        alt="Partner Name">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="#" class="transition duration-200 flex-center">
                                                    <img src="{{ asset('assets/frontend/assets/img/partners/logo4.svg') }}"
                                                        alt="Partner Name">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                ...
                <div data-scroll-index="1" id="about"
                    ...
                    <div
                        class="px-5 py-8 bg-white md:p-8 dark:bg-nightBlack rounded-2xl about-section lg:p-10 2xl:p-13">
                        <div
                            class="inline-flex items-center gap-2 px-4 py-2 text-xs tracking-wide text-black border dark:text-white lg:px-5 section-name border-platinum dark:border-greyBlack200 rounded-4xl">
                ...
                <div data-scroll-index="3" id="skill"
                    ...
                    <div
                        class="relative px-5 py-8 bg-white md:p-8 dark:bg-nightBlack rounded-2xl service-section lg:p-10 2xl:p-13">
                        <div
                            class="inline-flex items-center gap-2 px-4 py-2 text-xs tracking-wide text-black border dark:text-white lg:px-5 section-name border-platinum dark:border-greyBlack200 rounded-4xl">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="space-y-5 text-center swiper-slide">
                                        <div class="text-center icon">
                                            <img src="{{ asset('assets/frontend/assets/img/skill/figma.svg') }}"
                                                class="dark:grayscale" alt="Figma">
                                        </div>
                                    ...
                                    <div class="space-y-5 text-center swiper-slide">
                                        <div class="text-center icon">
                                            <img src="{{ asset('assets/frontend/assets/img/skill/webflow.svg') }}"
                                                class="dark:grayscale" alt="webflow">
                                        </div>
                                        <div class="progressCircle">
                                            <div class="relative w-32 h-32 mx-auto circle md:w-40 md:h-40"
                                                data-percent="85">
                                    ...
                                    <div class="space-y-5 text-center swiper-slide">
                                        <div class="text-center icon">
                                            <img src="{{ asset('assets/frontend/assets/img/skill/css.svg') }}"
                                                class="dark:grayscale" alt="CSS3">
                                        </div>
                                        <div class="progressCircle">
                                            <div class="relative w-32 h-32 mx-auto circle md:w-40 md:h-40"
                                                data-percent="95">
                                    ...
                                    <div class="space-y-5 text-center swiper-slide">
                                        <div class="text-center icon">
                                            <img src="{{ asset('assets/frontend/assets/img/skill/js.svg') }}"
                                                class="dark:grayscale" alt="JavaScript">
                                        </div>
                                        <div class="progressCircle">
                                            <div class="relative w-32 h-32 mx-auto circle md:w-40 md:h-40"
                                                data-percent="75">
                                    ...
                                    <div class="space-y-5 text-center swiper-slide">
                                        <div class="text-center icon">
                                            <img src="{{ asset('assets/frontend/assets/img/skill/jquery.svg') }}"
                                                class="dark:grayscale" alt="jQuery">
                                        </div>
                                        <div class="progressCircle">
                                            <div class="relative w-32 h-32 mx-auto circle md:w-40 md:h-40"
                                                data-percent="70">
                            ...
                            <ul
                                ...
                                <li
                                    ...
                                    <div class="flex items-center justify-between mb-5 md:w-64 md:block md:mb-0">
                                        <h6
                                            class="text-sm font-medium text-black dark:text-white text-opacity-60 md:text-base md:text-opacity-100">
                                            Darikandi Badda Asmatunnesa High school
                                        </h6>
                                        <p class="text-[13px] md:text-sm text-theme">
                                            2016-2017
                                        </p>
                        ...
                        <div class="portfolio_wrapper grid sm:grid-cols-2 gap-4 lg:gap-7.5">
                            ...
                            <div class="relative item md:col-span-1 z-1 group">
                                <a class='flex items-center justify-center p-3 overflow-hidden border md:p-4 rounded-xl border-platinum dark:border-greyBlack'
                                    href='project-single.html'>
                                    <div class="img-wrapper">
                                        <img src="{{ asset('assets/frontend/assets/img/portfolio/portfolio-img2.png') }}"
                                            class="rounded-lg max-md:min-h-[17rem] max-md:w-full max-md:object-cover max-md:object-center transition-all duration-300 group-hover:blur-xs"
                                            alt="portfolio">
                                        <div
                                            class="absolute inset-0 transition-all duration-300 opacity-0 overlay bg-gradient-to-t from-white dark:from-black to-transparent rounded-xl group-hover:opacity-100">
                            ...
                            <div class="relative item md:col-span-1 z-1 group">
                                <a class='flex items-center justify-center p-3 overflow-hidden border md:p-4 rounded-xl border-platinum dark:border-greyBlack'
                                    href='project-single.html'>
                                    <div class="img-wrapper">
                                        <img src="{{ asset('assets/frontend/assets/img/portfolio/portfolio-img3.png') }}"
                                            class="rounded-lg max-md:min-h-[17rem] max-md:w-full max-md:object-cover max-md:object-center transition-all duration-300 group-hover:blur-xs"
                                            alt="portfolio">
                                        <div
                                            class="absolute inset-0 transition-all duration-300 opacity-0 overlay bg-gradient-to-t from-white dark:from-black to-transparent rounded-xl group-hover:opacity-100">
                            ...
                            <div class="relative item md:col-span-2 z-1 group">
                                <a class='flex items-center justify-center p-3 overflow-hidden border md:p-4 rounded-xl border-platinum dark:border-greyBlack'
                                    href='project-single.html'>
                                    <div class="img-wrapper">
                                        <img src="{{ asset('assets/frontend/assets/img/portfolio/portfolio-img4.png') }}"
                                            class="rounded-lg max-md:min-h-[17rem] max-md:w-full max-md:object-cover max-md:object-center transition-all duration-300 group-hover:blur-xs"
                                            alt="portfolio">
                                        <div
                                            class="absolute inset-0 transition-all duration-300 opacity-0 overlay bg-gradient-to-t from-white dark:from-black to-transparent rounded-xl group-hover:opacity-100">
                            ...
                            <div class="swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="text-center slider-inner md:px-5">
                                            <div class="image flex-center">
                                                <img src="{{ asset('assets/frontend/assets/img/testimonial/author1.png') }}"
                                                    alt="">
                                            </div>
                                            ...
                                            <div class="mt-5 text-center author">
                                                <h6 class="text-lg font-medium text-black dark:text-white">Alex Johnson
                                                </h6>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="text-center slider-inner md:px-5">
                                            <div class="image flex-center">
                                                <img src="{{ asset('assets/frontend/assets/img/testimonial/author2.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="mt-6 mb-3 text-center rating text-lightOrange">
                                                <svg width="15" height="15" viewBox="0 0 15 15"
                                            ...
                                            <div class="mt-5 text-center author">
                                                <h6 class="text-lg font-medium text-black dark:text-white">Mily Martin
                                                </h6>
                                ...
                                <div
                                    ...
                                    <div class="text-sm font-light text-center text-black dark:text-white counter w-7">
                                    </div>
                                    <button
                                        class="transition border rounded-full button-next w-11 h-11 group border-platinum dark:border-greyBlack flex-center hover:bg-theme hover:border-theme"
                                        aria-label="Next">
                    ...
                    <div class="px-5 py-8 bg-white dark:bg-nightBlack rounded-2xl contact-section lg:p-13">
                        ...
                        <div class="grid gap-12 mt-8 mb-10 md:my-12 md:grid-cols-12">
                                ...
                                <ul class="space-y-6 md:space-y-10 2xl:space-y-12 contact-info">
                                    ...
                                    <li class="flex flex-wrap items-center gap-5">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-sm">mdshahnewaz77@gmail.com</p>
                                        </div>
                                    </li>
                                    <li class="flex flex-wrap items-center gap-5">
                                        <div class="flex justify-center w-12 icon">
                            ...
                            <div class="md:col-span-7">
                                <form id="contactForm" action="https://minfotailwind.netlify.app/contact-form.php"
